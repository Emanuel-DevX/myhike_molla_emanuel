  ...
  db.collection("quotes")
    ...
    .onSnapshot(
      (dayDoc) => {
        ...
        document.getElementById("quote").innerHTML = dayDoc.data().quote; //using javascript to display the data on the right place
...
// readQuote("tue"); //calling the function
function writeHikes() {
    ...
    if (bookmarks.includes(hikeDocID)) {
      ...
      currentUser
        ...
        .then(() => {
          ...
          document.getElementById("save-" + hikeDocID).innerText = "bookmark"; // Filled icon
        });
    }
  });
}
